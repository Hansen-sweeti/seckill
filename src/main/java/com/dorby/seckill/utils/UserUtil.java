...
public class UserUtil {
    ...
    private static void createUser(int count) throws SQLException, IOException, ClassNotFoundException {
        ...
        for(int i=0;i<users.size();i++){
            ...
            String params="mobile=" + user.getId()+"&password=" +MD5Util.inputPassToPass("123456");
    ...
    private static Connection getConn() throws ClassNotFoundException, SQLException {
        String url="jdbc:mysql://192.168.77.131:3306/seckill?useUnicode=true&characterEncoding=UTF-8&serverTimezone=Asia/Shanghai";
